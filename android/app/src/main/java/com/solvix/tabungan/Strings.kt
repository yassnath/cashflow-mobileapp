...
fun stringsFor(language: AppLanguage): AppStrings {
  val id = mapOf(
    ...
    "label_goal_source" to "Sumber Progress",
    ...
    "placeholder_goal_source" to "Select Source",
    ...
    "goal_reached_popup_income_balance" to "Selamat! Kamu telah berhasil memenuhi target kamu!",
    "goal_reached_popup_expense" to "Target pengeluaran kamu sudah terpenuhi!",
    "goal_reached_notification_title" to "Target Tercapai",
    "goal_reached_notification_desc" to "Notifikasi saat target tercapai",
    "goal_reached_notification_body" to "{title}. {message}",
    "goal_source_income" to "Pemasukkan",
    "goal_source_expense" to "Pengeluaran",
    "goal_source_balance" to "Saldo",
  ...
  val en = mapOf(
    ...
    "label_bank" to "Bank / Wallet",
    "label_goal" to "Goal",
    "label_goal_source" to "Progress Source",
    ...
    "income_deleted" to "Income deleted",
    ...
    "goal_reached_popup_income_balance" to "Congrats! You have reached your goal target!",
    "goal_reached_popup_expense" to "Your expense target has been reached!",
    "goal_reached_notification_title" to "Goal Reached",
    "goal_reached_notification_desc" to "Notification when a goal target is reached",
    "goal_reached_notification_body" to "{title}. {message}",
    "goal_source_income" to "Income",
    "goal_source_expense" to "Expense",
    "goal_source_balance" to "Balance",
