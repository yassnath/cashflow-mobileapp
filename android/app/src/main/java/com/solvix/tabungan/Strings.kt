...
fun stringsFor(language: AppLanguage): AppStrings {
  val id = mapOf(
    ...
    "confirm_delete_saving" to "Hapus tabungan ini?",
    ...
    "save_saving" to "Simpan Tabungan",
    "update_saving" to "Update Tabungan",
    ...
    "section_saving_title" to "Tabungan",
    "section_saving_subtitle" to "Target tabungan jadi lebih cepat tercapai.",
    ...
    "list_saving" to "Daftar Tabungan",
    ...
    "settings_face" to "Login dengan Face Unlock",
    "settings_face_desc" to "Butuh face unlock aktif & lockscreen",
    ...
    "face_enabled" to "Face unlock aktif.",
    "face_required" to "Aktifkan face unlock dan lockscreen dulu.",
    "face_prompt_title" to "Login dengan Face Unlock",
    "face_prompt_subtitle" to "Gunakan face unlock untuk masuk",
    "auth_face" to "Masuk dengan Face Unlock",
  ...
  val en = mapOf(
    ...
    "confirm_delete_saving" to "Delete this saving?",
    ...
    "save_saving" to "Save Savings",
    "update_saving" to "Update Savings",
    ...
    "section_saving_title" to "Savings",
    "section_saving_subtitle" to "Reach your savings targets faster.",
    ...
    "settings_face" to "Face Unlock Login",
    "settings_face_desc" to "Requires face unlock & lockscreen",
    ...
    "face_enabled" to "Face unlock enabled.",
    "face_required" to "Enable face unlock and lockscreen first.",
    "face_prompt_title" to "Face Unlock Login",
    "face_prompt_subtitle" to "Use face unlock to sign in",
    "auth_face" to "Sign in with Face Unlock",
